...
SCHEMA_PATH = Path('/home/letbu/Downloads/DevSpec Synth Agent/backend/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'debian-openssl-3.0.x': '/home/letbu/.cache/prisma-python/binaries/5.11.0/efd2449663b3d73d637ea1fd226bafbcf45b3102/node_modules/prisma/query-engine-debian-openssl-3.0.x'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    projectspec: 'actions.ProjectSpecActions[models.ProjectSpec]'
    ...
    def __init__(
        ...
        *,
        ...
        self.projectspec = actions.ProjectSpecActions[models.ProjectSpec](self, models.ProjectSpec)
...
class Batch:
    projectspec: 'ProjectSpecBatchActions'

    def __init__(self, client: Prisma) -> None:
        self.__client = client
        self.__queries: List[str] = []
        self._active_provider = client._active_provider
        self.projectspec = ProjectSpecBatchActions(self)
